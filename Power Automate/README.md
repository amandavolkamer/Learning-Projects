...
This folder showcases various **Power Automate Desktop** workflows that I created, or are currently working on to maintain and continue to grow my skills in Power Automate.
Some of the workflows for the RPA Challenges were tasks I've completed in my previous roles however I wanted to rebuild those workflows to showcase my skills.
...
- **Challenge:** The goal of this challenge is to create an attended robot that works in tandem with the user.
- **Solution:** Use **UI Selectors**.
